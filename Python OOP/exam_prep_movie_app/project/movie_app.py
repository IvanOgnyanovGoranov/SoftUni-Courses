...
class MovieApp:
    ...
    def register_user(self, username: str, age: int):
        user_exists = next((u.username for u in self.users_collection if username == u.username), None)
        if user_exists:
    ...
    def upload_movie(self, username: str, movie: Movie):
        user = next((u for u in self.users_collection if username == u.username), None)
        if not user:
    ...
    def edit_movie(self, username: str, movie: Movie, **kwargs):
        ...
        if movie not in user.movies_owned:
            return f"{username} is not the owner of the movie {movie.title}!"

        #not sure if that changes the attributes of the movie in the movies list:
